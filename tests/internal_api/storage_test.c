...
static uint8_t modulus[] =
    "\x88\x3e\x6b\x47\x4e\xdb\x4a\x36\xa4\xf4\x7f\x2f\x88\xc9\xdd\x96\x45\xf0\xee"
...
static uint32_t rename_per_obj_and_enum_and_open_renameObj()
{
	...
	if (ret != TEE_ERROR_ACCESS_CONFLICT) {
		PRI_FAIL("Object rename should have failed with TEE_ERROR_ACCESS_CONFLICT : 0x%x",
			 ret);
		goto err;
	}
