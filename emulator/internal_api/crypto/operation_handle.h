...
struct gp_key {
	 ...
	 * Count is increaset: TEE_CreatePersistentObject (if object parameter
	 * countaint key) TEE_PopulateTransientObject TEE_CopyObjectAttributes1
	 *						TEE_CopyOperation
	 *						TEE_SetOperationKey
	 *
	 ...
	 *					   TEE_SetOperationKey
	 * After decrement the variable is checked and if it zero, key will be
	 * destroyed */
