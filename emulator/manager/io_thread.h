 ...
 * Removes and clears manager_msg structs from inbould and outbound queues
 * matching the given proc
 * \param struct __proc* or proc, messages are check agaist this proc to be
 * removed
 */
