...
struct emulator_config {
	...
	char *subprocess_manager;  /*!< The library that implements the manager
				      fucnctionality */
	char *subprocess_launcher; /*!< The library that implements the TA launcher
				      functionality */
 ...
 * \param conf is allocated memory via malloc caller must free with
 * config_parser_free_config
 ...
 * Free an emulator config struct that has been assigned with
 * config_parser_get_config
