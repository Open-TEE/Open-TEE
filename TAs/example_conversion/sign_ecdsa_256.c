...
SET_TA_PROPERTIES({0x12345678, 0x8765, 0x4321, {'S', 'I', 'G', 'N', 'S', 'I', 'G', 'N'}}, /* UUID */
		  512, /* dataSize */
		  255, /* stackSize */
		  1,   /* singletonInstance */
		  1,   /* multiSession */
...
TEE_Result TA_EXPORT TA_CreateEntryPoint(void)
{
	...
	rv = TEE_CreatePersistentObject(TEE_STORAGE_PRIVATE, objID, objID_len,
	...
	rv = TEE_AllocateOperation(&sign_operation, TEE_ALG_ECDSA_SHA256, TEE_MODE_SIGN, 256);
	if (rv != TEE_SUCCESS) {
...
void TA_EXPORT TA_DestroyEntryPoint(void) { TEE_FreeOperation(TEE_GetInstanceData()); }
