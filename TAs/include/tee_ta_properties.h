...
#ifndef __TEE_TA_PROPERTIES_H__
#define __TEE_TA_PROPERTIES_H__

/* How to add/insert ta properties to our ta:
 * Use SET_TA_PROPERTIES macro in our source (.c) file.
 *
 * Example:
...
#define SET_TA_PROPERTIES(...) struct gpd_ta_config ta_pro \
	__attribute__ ((section(PROPERTY_SEC_NAME))) = { __VA_ARGS__ };
